...
Description: An example plugin for the TECHCareers class. It provides an example of a WordPress shortcode. Type [techcareerscalculator] into a page or post to output our calculator.
Author: Warren Uhrich
Version: 1.0
Author URI: https://WarrenUhrich.ca
*/

/**
 
 * Original calculator source code:
